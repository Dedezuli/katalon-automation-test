...
WebUI.setText(findTestObject('Ready to Pay/input_search_grouping'), 'POA Promo Online')
...
WebUI.selectOptionByLabel(findTestObject('Ready to Pay/Select Payment Type (1)'), 'CASH', false)
...
WebUI.verifyElementPresent(findTestObject('Ready to Pay/div_Total Transfer Tidak Boleh Kosong'), 3)
