...
WebUI.click(findTestObject('POA/Timeline/Approval/a_Edit'))

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

WebUI.selectOptionByLabel(findTestObject('POA/Timeline/Approval/select_Payment Type_Edit'), Payment_Type, false)

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('POA/Timeline/Approval/button_Save_Edit'))

WebUI.waitForElementPresent(findTestObject('POA/Timeline/Approval/textarea_Comment'), 5)

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

String paymentType = WebUI.getAttribute(findTestObject('POA/Timeline/Approval/input_Payment Type'), 'value')

WebUI.verifyMatch(paymentType, Payment_Type, false, FailureHandling.STOP_ON_FAILURE)
