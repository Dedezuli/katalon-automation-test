...
WebUI.setText(findTestObject('POA/Timeline/Create Program/input_Product_PercentContribute'), '50')
...
WebUI.waitForElementPresent(findTestObject('POA/Timeline/Create Program/button_Save'), 3)
...
WebUI.verifyMatch(alertText, '- Total Brand %contribute harus 100% \n', false)
