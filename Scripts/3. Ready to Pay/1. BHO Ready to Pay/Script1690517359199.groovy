...
WebUI.setText(findTestObject('Ready to Pay/input_search_grouping'), Grouping)

WebUI.click(findTestObject('Ready to Pay/button_Select_grouping'))

WebUI.click(findTestObject('Ready to Pay/button_BRANCH NAME'))

WebUI.setText(findTestObject('Ready to Pay/input_search_Branch'), Branch)
...
WebUI.setText(findTestObject('Ready to Pay/input_search_department'), Department)

WebUI.click(findTestObject('Ready to Pay/button_Select_Department'))

WebUI.selectOptionByLabel(findTestObject('Ready to Pay/Select KN'), KN, false)

WebUI.selectOptionByLabel(findTestObject('Ready to Pay/Select Type Budget'), Type_Budget, false)

WebUI.selectOptionByLabel(findTestObject('Ready to Pay/Select Payment Type (1)'), Payment_Type, false)

WebUI.selectOptionByLabel(findTestObject('Ready to Pay/Select Bank Type'), Bank, false)

WebUI.selectOptionByLabel(findTestObject('Ready to Pay/Select Promo Type'), Promo_Type, false)
