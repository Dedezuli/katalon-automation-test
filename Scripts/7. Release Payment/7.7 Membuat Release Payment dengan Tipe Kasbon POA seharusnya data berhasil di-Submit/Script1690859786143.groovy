...
WebUI.click(findTestObject('Release Payment/a_DatePick', [('dateRelease') : dateRelease]))
...
WebUI.setText(findTestObject('Release Payment/input_DESCRIPTION'), Description)

WebUI.click(findTestObject('Release Payment/input_first checkbox'), FailureHandling.STOP_ON_FAILURE)
...
not_run: transNo = WebUI.getAttribute(findTestObject('Release Payment/input_TRANSACTION NO'), 'value')

not_run: WebUI.verifyNotMatch(transNo, '[AUTO GENERATED]', false)
