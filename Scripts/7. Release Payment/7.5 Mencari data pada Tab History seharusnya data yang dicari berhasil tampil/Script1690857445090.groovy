...
WebUI.setText(findTestObject('Release Payment/input_History_Search'), 'SUTRISNI', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Release Payment/button_History_Search'), FailureHandling.STOP_ON_FAILURE)
