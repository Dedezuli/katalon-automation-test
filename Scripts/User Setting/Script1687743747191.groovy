...
WebUI.setText(findTestObject('Login/input_Password'), 'as')
...
WebUI.click(findTestObject('User Setting/input_Role', [('roleID') : '159']))

WebUI.click(findTestObject('User Setting/input_Branch', [('branchID') : '111']))
